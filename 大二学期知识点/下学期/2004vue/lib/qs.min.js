! function(t) { "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : ("undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : this).Qs = t() }(function() {
    return function o(n, i, a) {
        function p(e, t) {
            if (!i[e]) {
                if (!n[e]) { var r = "function" == typeof require && require; if (!t && r) return r(e, !0); if (c) return c(e, !0); throw (r = new Error("Cannot find module '" + e + "'")).code = "MODULE_NOT_FOUND", r }
                r = i[e] = { exports: {} }, n[e][0].call(r.exports, function(t) { return p(n[e][1][t] || t) }, r, r.exports, o, n, i, a)
            }
            return i[e].exports
        }
        ...
        1: [function(t, e, r) {
            ...
            var o = String.prototype.replace,
                ...
                i = "RFC1738",
                a = "RFC3986";
            e.exports = { default: a, formatters: { RFC1738: function(t) { return o.call(t, n, "+") }, RFC3986: function(t) { return String(t) } }, RFC1738: i, RFC3986: a }
        }, {}],
        2: [function(t, e, r) {
            "use strict";
            var o = t("./stringify"),
        ...
        3: [function(t, e, r) {
            ...
            function c(t, e) {
                ...
                if (e.charsetSentinel)
                    for (r = 0; r < c.length; ++r) 0 === c[r].indexOf("utf8=") && ("utf8=%E2%9C%93" === c[r] ? f = "utf-8" : "utf8=%26%2310003%3B" === c[r] && (f = "iso-8859-1"), l = r, r = c.length);
                for (r = 0; r < c.length; ++r) r !== l && ((i = -1 === (i = -1 === (i = (o = c[r]).indexOf("]=")) ? o.indexOf("=") : i + 1) ? (n = e.decoder(o, d.decoder, f, "key"), e.strictNullHandling ? null : "") : (n = e.decoder(o.slice(0, i), d.decoder, f, "key"), u.maybeMap(b(o.slice(i + 1), e), function(t) { return e.decoder(t, d.decoder, f, "value") }))) && e.interpretNumericEntities && "iso-8859-1" === f && (i = i.replace(/&#(\d+);/g, function(t, e) { return String.fromCharCode(parseInt(e, 10)) })), -1 < o.indexOf("[]=") && (i = s(i) ? [i] : i), y.call(a, n) ? a[n] = u.combine(a[n], i) : a[n] = i);
                return a
            }
            ...
            function l(t, e, r, o) {
                if (t) {
                    ...
                    return a && p.push("[" + n.slice(a.index) + "]"),
                        function(t, e, r, o) { for (var n = o ? e : b(e, r), i = t.length - 1; 0 <= i; --i) { var a, p, c, l = t[i]; "[]" === l && r.parseArrays ? a = [].concat(n) : (a = r.plainObjects ? Object.create(null) : {}, p = "[" === l.charAt(0) && "]" === l.charAt(l.length - 1) ? l.slice(1, -1) : l, c = parseInt(p, 10), r.parseArrays || "" !== p ? !isNaN(c) && l !== p && String(c) === p && 0 <= c && r.parseArrays && c <= r.arrayLimit ? (a = [])[c] = n : "__proto__" !== p && (a[p] = n) : a = { 0: n }), n = a } return n }(p, e, r, o)
                }
            }
            var u = t("./utils"),
        ...
        4: [function(t, e, r) {
            ...
            function R(t, e) { o.apply(t, U(e) ? e : [e]) }
            ...
            function N(t, e, r, o, n, i, a, p, c, l, f, u, y, s, d) {
                ...
                if ("function" == typeof a ? g = a(e, g) : g instanceof Date ? g = l(g) : "comma" === r && U(g) && (g = D.maybeMap(g, function(t) { return t instanceof Date ? l(t) : t })), null === g) {
                    if (o) return i && !y ? i(e, W.encoder, s, "key", f) : e;
                    g = ""
                }
                if ("string" == typeof(b = g) || "number" == typeof b || "boolean" == typeof b || "symbol" == typeof b || "bigint" == typeof b || D.isBuffer(g)) { if (i) { var j = y ? e : i(e, W.encoder, s, "key", f); if ("comma" === r && y) { for (var A = _.call(String(g), ","), O = "", w = 0; w < A.length; ++w) O += (0 === w ? "" : ",") + u(i(A[w], W.encoder, s, "value", f)); return [u(j) + "=" + O] } return [u(j) + "=" + u(i(g, W.encoder, s, "value", f))] } return [u(e) + "=" + u(String(g))] }
                var P, x = [];
            ...
            var M = t("side-channel"),
                ...
                y = { brackets: function(t) { return t + "[]" }, comma: "comma", indices: function(t, e) { return t + "[" + e + "]" }, repeat: function(t) { return t } },
                U = Array.isArray,
                _ = String.prototype.split,
                o = Array.prototype.push,
                n = Date.prototype.toISOString,
                t = f.default,
                W = { addQueryPrefix: !1, allowDots: !1, charset: "utf-8", charsetSentinel: !1, delimiter: "&", encode: !0, encoder: D.encode, encodeValuesOnly: !1, format: t, formatter: f.formatters[t], indices: !1, serializeDate: function(t) { return n.call(t) }, skipNulls: !1, strictNullHandling: !1 },
                B = {};
            e.exports = function(t, e) {
                var r = t,
                    o = function(t) {
        ...
        5: [function(t, e, r) {
            ...
            function p(t, e) { for (var r = e && e.plainObjects ? Object.create(null) : {}, o = 0; o < t.length; ++o) void 0 !== t[o] && (r[o] = t[o]); return r }
            var l = t("./formats"),
                c = Object.prototype.hasOwnProperty,
                f = Array.isArray,
                u = function() { for (var t = [], e = 0; e < 256; ++e) t.push("%" + ((e < 16 ? "0" : "") + e.toString(16)).toUpperCase()); return t }(),
                t = function o(n, i, a) {
                    if (!i) return n;
                    if ("object" != typeof i) {
                        if (f(n)) n.push(i);
                    ...
                    var t = n;
                    return f(n) && !f(i) && (t = p(n, a)), f(n) && f(i) ? (i.forEach(function(t, e) {
                        var r;
                        c.call(n, e) ? (r = n[e]) && "object" == typeof r && t && "object" == typeof t ? n[e] = o(r, t, a) : n.push(t) : n[e] = t
                    }), n) : Object.keys(i).reduce(function(t, e) { var r = i[e]; return c.call(t, e) ? t[e] = o(t[e], r, a) : t[e] = r, t }, t)
                };
            e.exports = {
                arrayToObject: p,
                assign: function(t, r) { return Object.keys(r).reduce(function(t, e) { return t[e] = r[e], t }, t) },
                ...
                decode: function(e, t, r) { e = e.replace(/\+/g, " "); if ("iso-8859-1" === r) return e.replace(/%[0-9a-f]{2}/gi, unescape); try { return decodeURIComponent(e) } catch (t) { return e } },
                encode: function(t, e, r, o, n) {
                    if (0 === t.length) return t;
                    var i = t;
                    if ("symbol" == typeof t ? i = Symbol.prototype.toString.call(t) : "string" != typeof t && (i = String(t)), "iso-8859-1" === r) return escape(i).replace(/%u[0-9a-f]{4}/gi, function(t) { return "%26%23" + parseInt(t.slice(2), 16) + "%3B" });
                ...
                maybeMap: function(t, e) { if (f(t)) { for (var r = [], o = 0; o < t.length; o += 1) r.push(e(t[o])); return r } return e(t) },
                merge: t
            }
        }, { "./formats": 1 }],
        6: [function(t, e, r) {}, {}],
        7: [function(t, e, r) {
            ...
            e.exports = function(t, e) { e = o(t, !!e); return "function" == typeof e && -1 < i(t, ".prototype.") ? n(e) : e }
        }, { "./": 8, "get-intrinsic": 11 }],
        8: [function(t, e, r) {
            "use strict";
            var o = t("function-bind"),
                ...
                l = t("%Math.max%");
            if (c) try { c({}, "a", { value: 1 }) } catch (t) { c = null }
            e.exports = function(t) { var e = a(o, i, arguments); return p && c && p(e, "length").configurable && c(e, "length", { value: 1 + l(0, t.length - (arguments.length - 1)) }), e };
        ...
        9: [function(t, e, r) {
            ...
            e.exports = function(e) { var r = this; if ("function" != typeof r || "[object Function]" !== l.call(r)) throw new TypeError("Function.prototype.bind called on incompatible " + r); for (var o, t, n = c.call(arguments, 1), i = Math.max(0, r.length - n.length), a = [], p = 0; p < i; p++) a.push("$" + p); return o = Function("binder", "return function (" + a.join(",") + "){ return binder.apply(this,arguments); }")(function() { if (this instanceof o) { var t = r.apply(this, n.concat(c.call(arguments))); return Object(t) === t ? t : this } return r.apply(e, n.concat(c.call(arguments))) }), r.prototype && ((t = function() {}).prototype = r.prototype, o.prototype = new t, t.prototype = null), o }
        }, {}],
        10: [function(t, e, r) {
            "use strict";
            t = t("./implementation");
        ...
        11: [function(t, e, r) {
            ...
            var s = SyntaxError,
                o = Function,
                d = TypeError,
                n = function(t) { try { return o('"use strict"; return (' + t + ").constructor;")() } catch (t) {} },
                b = Object.getOwnPropertyDescriptor;
            if (b) try { b({}, "") } catch (t) { b = null }

            function i() { throw new d }

            function g(t) { var e, r; return "%AsyncFunction%" === t ? e = n("async function () {}") : "%GeneratorFunction%" === t ? e = n("function* () {}") : "%AsyncGeneratorFunction%" === t ? e = n("async function* () {}") : "%AsyncGenerator%" === t ? (r = g("%AsyncGeneratorFunction%")) && (e = r.prototype) : "%AsyncIteratorPrototype%" !== t || (r = g("%AsyncGenerator%")) && (e = c(r.prototype)), h[t] = e }
            var a = b ? function() { try { return i } catch (t) { try { return b(arguments, "callee").get } catch (t) { return i } } }() : i,
                p = t("has-symbols")(),
            ...
            e.exports = function(t, e) {
                ...
                var r, o = function(t) {
                        ...
                        var n = [];
                        return O(t, P, function(t, e, r, o) { n[n.length] = r ? O(o, x, "$1") : e || t }), n
                    }(t),
                    n = 0 < o.length ? o[0] : "",
                    i = function(t, e) { var r, o = t; if (v(S, o) && (o = "%" + (r = S[o])[0] + "%"), v(h, o)) { var n = h[o]; if (void 0 === (n = n === m ? g(o) : n) && !e) throw new d("intrinsic " + t + " exists, but is not available. Please file an issue!"); return { alias: r, name: o, value: n } } throw new s("intrinsic " + t + " does not exist!") }("%" + n + "%", e),
                    a = (i.name, i.value),
                    p = !1,
                    i = i.alias;
                i && (n = i[0], A(o, j([0, 1], i)));
                for (var c = 1, l = !0; c < o.length; c += 1) {
                    ...
                    if ("constructor" !== f && l || (p = !0), v(h, r = "%" + (n += "." + f) + "%")) a = h[r];
                        ...
                        if (!(f in a)) { if (!e) throw new d("base intrinsic for " + t + " exists, but the property is not available."); return }
        ...
        12: [function(t, e, r) {
            ...
            var o = "undefined" != typeof Symbol && Symbol,
                n = t("./shams");
            e.exports = function() { return "function" == typeof o && ("function" == typeof Symbol && ("symbol" == typeof o("foo") && ("symbol" == typeof Symbol("bar") && n()))) }
        }, { "./shams": 13 }],
        13: [function(t, e, r) {
            "use strict";
            e.exports = function() {
                ...
                if ("function" == typeof Object.getOwnPropertyDescriptor) { t = Object.getOwnPropertyDescriptor(t, e); if (42 !== t.value || !0 !== t.enumerable) return !1 }
                return !0
            }
        }, {}],
        14: [function(t, e, r) {
        ...
        15: [function(t, e, r) {
            var o = "function" == typeof Map && Map.prototype,
                ...
                L = ("function" == typeof Reflect ? Reflect : Object).getPrototypeOf || ([].__proto__ === Array.prototype ? function(t) { return t.__proto__ } : null);

            function G(t, e) { if (t === 1 / 0 || t === -1 / 0 || t != t || t && -1e3 < t && t < 1e3 || f.call(/e/, e)) return e; var r = /[0-9](?=(?:[0-9]{3})+(?![0-9]))/g; if ("number" == typeof t) { var o = t < 0 ? -p(-t) : p(t); if (o !== t) { t = String(o), o = I.call(e, t.length + 1); return R.call(t, r, "$&_") + "." + R.call(R.call(o, /([0-9]{3})/g, "$&_"), /_$/, "") } } return R.call(e, r, "$&_") }
            var t = t("./util.inspect").custom,
                q = t && V(t) ? t : null;

            function $(t, e, r) { e = "double" === (r.quoteStyle || e) ? '"' : "'"; return e + t + e }

            function H(t) { return !("[object Array]" !== Q(t) || C && "object" == typeof t && C in t) }

            function V(t) { if (B) return t && "object" == typeof t && t instanceof Symbol; if ("symbol" == typeof t) return 1; if (t && "object" == typeof t && W) try { return W.call(t), 1 } catch (t) {} }
            e.exports = function o(r, t, n, i) {
                ...
                if ("bigint" == typeof r) { var c = String(r) + "n"; return p ? G(r, c) : c }
                ...
                function f(t, e, r) { if (e && (i = U.call(i)).push(e), r) { r = { depth: a.depth }; return z(a, "quoteStyle") && (r.quoteStyle = a.quoteStyle), o(t, r, n + 1, i) } return o(t, a, n + 1, i) }
                ...
                if (!("[object Error]" !== Q(b = r) || C && "object" == typeof b && C in b)) { var g = et(r, f); return "cause" in r && !T.call(r, "cause") ? "{ [" + String(r) + "] " + D.call(M.call("[cause]: " + f(r.cause), g), ", ") + " }" : 0 === g.length ? "[" + String(r) + "]" : "{ [" + String(r) + "] " + D.call(g, ", ") + " }" }
                if ("object" == typeof r && e) { if (q && "function" == typeof r[q]) return r[q](); if ("symbol" !== e && "function" == typeof r.inspect) return r.inspect() }
                if (function(t) { if (!v || !t || "object" != typeof t) return !1; try { v.call(t); try { A.call(t) } catch (t) { return !0 } return t instanceof Map } catch (t) {} return !1 }(r)) { var m = []; return j.call(r, function(t, e) { m.push(f(e, r, !0) + " => " + f(t, r)) }), Z("Map", v.call(r), m, c) }
                if (function(t) { if (!A || !t || "object" != typeof t) return !1; try { A.call(t); try { v.call(t) } catch (t) { return !0 } return t instanceof Set } catch (t) {} return !1 }(r)) { var h = []; return O.call(r, function(t) { h.push(f(t, r)) }), Z("Set", A.call(r), h, c) }
                if (function(t) { if (!w || !t || "object" != typeof t) return !1; try { w.call(t, w); try { P.call(t, P) } catch (t) { return !0 } return t instanceof WeakMap } catch (t) {} return !1 }(r)) return Y("WeakMap");
                if (function(t) { if (!P || !t || "object" != typeof t) return !1; try { P.call(t, P); try { w.call(t, w) } catch (t) { return !0 } return t instanceof WeakSet } catch (t) {} return !1 }(r)) return Y("WeakSet");
                if (function(t) { if (!x || !t || "object" != typeof t) return !1; try { return x.call(t), !0 } catch (t) {} return !1 }(r)) return Y("WeakRef");
                if (!("[object Number]" !== Q(b = r) || C && "object" == typeof b && C in b)) return X(f(Number(r)));
                if (function(t) { if (!t || "object" != typeof t || !_) return !1; try { return _.call(t), !0 } catch (t) {} return !1 }(r)) return X(f(_.call(r)));
            ...
            var c = Object.prototype.hasOwnProperty || function(t) { return t in this };

            function z(t, e) { return c.call(t, e) }

            function Q(t) { return i.call(t) }
            ...
            function X(t) { return "Object(" + t + ")" }

            function Y(t) { return t + " { ? }" }

            function Z(t, e, r, o) { return t + " (" + e + ") {" + (o ? tt(r, o) : D.call(r, ", ")) + "}" }

            function tt(t, e) { if (0 === t.length) return ""; var r = "\n" + e.prev + e.base; return r + D.call(t, "," + r) + "\n" + e.prev }

            function et(t, e) {
                var r = H(t),
                    o = [];
                if (r) { o.length = t.length; for (var n = 0; n < t.length; n++) o[n] = z(t, n) ? e(t[n], t) : "" }
                var i, a = "function" == typeof u ? u(t) : [];
                if (B)
                ...
                if ("function" == typeof u)
                    for (var l = 0; l < a.length; l++) T.call(t, a[l]) && o.push("[" + e(a[l]) + "]: " + e(t[a[l]], t));
                return o
            }
        }, { "./util.inspect": 6 }],
        16: [function(t, e, r) {
            ...
            function p(t, e) {
                for (var r, o = t; null !== (r = o.next); o = r)
                    if (r.key === e) return o.next = r.next, r.next = t.next, t.next = r
            }
            var o = t("get-intrinsic"),
            ...
            e.exports = function() {
                var n, i, a, e = {
                    assert: function(t) { if (!e.has(t)) throw new l("Side channel does not contain " + c(t)) },
                    get: function(t) { if (f && t && ("object" == typeof t || "function" == typeof t)) { if (n) return y(n, t) } else if (u) { if (i) return b(i, t) } else if (a) return function(t, e) { e = p(t, e); return e && e.value }(a, t) },
                    has: function(t) { if (f && t && ("object" == typeof t || "function" == typeof t)) { if (n) return d(n, t) } else if (u) { if (i) return m(i, t) } else if (a) return !!p(a, t); return !1 },
                    set: function(t, e) {
                        var r, o;
